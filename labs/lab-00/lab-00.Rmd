...
```{r setup-tibble}
usernames <- c("wilsonamy", "Thomas", "Logan", "username 3", "username 4") #Extend if necessary
nums <- c(18, 18, 1, NA, NA) #Extend if necessary
colours <- c("powderblue", "Green", "blue", "colour 2", "colour 4") #Extend if necessary
hobbies <- c("Hiking", "Tennis", "subway", "Hobby 3", "Hobby 4") #Extend if necessary
