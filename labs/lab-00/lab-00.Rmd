...
```{r setup-tibble}
usernames <- c("wilsonamy", "Thomas", "username 2", "username 3", "username 4") #Extend if necessary
nums <- c(18, 18, NA, NA, NA) #Extend if necessary
colours <- c("powderblue", "Green", "colour 2", "colour 2", "colour 4") #Extend if necessary
hobbies <- c("Hiking", "Tennis", "Hobby 2", "Hobby 3", "Hobby 4") #Extend if necessary
